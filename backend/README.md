...
## Project Structure
    ...
    ├── testing_videoplayer_38790  # Django project configurations
...
1. Clone this repo and `cd testing_videoplayer_38790`
...
2. Clone this repo and `cd testing_videoplayer_38790`
